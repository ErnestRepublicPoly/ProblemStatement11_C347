...
public class BioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.fragment_bio, container, false);
        ...
        Button edit = root.findViewById(R.id.buttonEdit);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final EditText bio = new EditText(getContext());
                final AlertDialog.Builder editDialog = new AlertDialog.Builder(getContext());
                editDialog.setTitle("Edit Bio");
                editDialog.setView(bio);

                editDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        final String text = bio.getText().toString();
                        TextView tvBio = root.findViewById(R.id.textViewBio);
                        tvBio.setText(text);
                    }
                });
